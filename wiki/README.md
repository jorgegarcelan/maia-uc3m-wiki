# Wiki del Máster Universitario en Inteligencia Artificial Aplicada (UC3M)
...
| Cargo | Nombre |
|-------|--------|
| Director | Prof. Dr. D. Jesús García Herrero |
| Subdirector | Prof. Dr. D. Agapito Ismael Ledezma Espino |

---

## Ejemplos de consultas

Para ver **preguntas frecuentes resueltas de ejemplo** (matrícula, primer semicuatrimestre, horarios, conciliación con trabajo), consulta la carpeta **[ejemplos](../ejemplos/README.md)** del repositorio.
...
- [Matrícula y Precios](matricula-y-precios.md) — Costes, reserva de plaza y normativa
- [Becas y Ayudas](becas.md) — Ayudas de matrícula UC3M y otras becas
- [Complementos Formativos](complementos-formativos.md) — Asignaturas previas para perfiles no técnicos
- [Prácticas y TFM](practicas-tfm.md) — Guía de prácticas en empresa y Trabajo Fin de Máster
...
- [Profesorado](profesorado.md) — Listado de profesores y departamentos
- [Doble Máster](doble-master.md) — Doble Máster en Ingeniería Informática + IA Aplicada

---

## Enlaces Oficiales

- [Web del Máster (UC3M)](https://www.uc3m.es/master/inteligencia-artificial-aplicada)
- [Horarios Oficiales](https://aplicaciones.uc3m.es/horarios-web/publicacion/master.page?plan=475&centro=4)
...
| Obligatorios | 3 ECTS (Implic. Éticas y Legales) |
| Optativos | 45 ECTS |
